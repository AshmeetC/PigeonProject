...
function About() {
    return (
        <div id="about" className="min-h-screen w-full items-center justify-between text-3xl bg-orange-200 flex flex-col justify-center text-center h-full py-48">  
            ...
            <div className="flex flex-col justify-center items-center">
                <motion.div initial={{ x: -300, opacity : 0, y: 150}} whileInView={{ x: 0, opacity: 1, y: 0}}
  transition={{ ease: "easeInOut", duration: 0.5 }} className="flex flex-col lg:flex-row mb-10 gap-10 py-48 px-20 w-5/6 bg-emerald-600 rounded-3xl">
                ...
                <motion.div initial={{ x: 300, opacity : 0, y: 150 }} whileInView={{ x: 0, opacity : 1, y: 0}}
  transition={{ ease: "easeInOut", duration: 0.5 }} className="flex flex-col gap-10 lg:flex-row py-48 px-20 w-5/6 rounded-3xl bg-emerald-600">
                    <div className="w-full h-full mt-36 lg:mt-0">
                        <img className="w-full h-full" src="https://placehold.co/600x400" alt="" />
                    </div>
