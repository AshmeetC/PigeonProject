...
function Team() {
    ...
    return (
        <div id="team" className="items-center h-full w-screen flex-col space-y-4 py-32 flex justify-center">
          ...
          <motion.div initial={{ width: 0 }}
            ...
            <motion.div initial={{ y: 50, opacity : 0}} whileInView={{ y: 0, opacity: 1}} transition={{ ease: "easeInOut", duration: 0.5 }} className="flex flex-col lg:flex-row mb-10 gap-10  bg-[#2f9fcf] rounded-3xl">
