...
function Team() {
    ...
    return (
        <div id="team" className="h-screen w-screen bg-orange-100 flex-col space-y-4 py-32">
            <h1 className="text-7xl text-center">Our Team</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 px-16 flex">
                <div className="py-8 px-8 bg-emerald-600 rounded-2xl flex flex-col items-center justify-center">
